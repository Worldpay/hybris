...
import { WorldpayApmPaymentInfo, WorldpayCheckoutPaymentService } from '../../../core';
...
export class WorldpayCheckoutScheduleReplenishmentOrderComponent extends CheckoutScheduleReplenishmentOrderComponent implements OnInit, OnDestroy {
  ...
  override ngOnInit(): void {
    ...
    this.showReplenishmentForm$ = this.worldpayCheckoutPaymentService.getPaymentDetailsState().pipe(
