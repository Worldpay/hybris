...
import { Address, FeatureDirective, GlobalMessageService, I18nTestingModule, UserAddressService, UserCostCenterService, } from '@spartacus/core';
import { CardComponent, SpinnerComponent } from '@spartacus/storefront';
import { BehaviorSubject, EMPTY, of } from 'rxjs';
import { MockCxCardComponent, MockCxFeatureDirective, MockCxSpinnerComponent } from 'worldpay-sap-composable-tests';
...
describe('WorldpayCheckoutB2BCheckoutDeliveryAddressComponent', () => {
  let component: WorldpayCheckoutB2BCheckoutDeliveryAddressComponent;
  let fixture: ComponentFixture<WorldpayCheckoutB2BCheckoutDeliveryAddressComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [I18nTestingModule, WorldpayCheckoutB2BCheckoutDeliveryAddressComponent],
      providers: [
        {
    ...
    }).overrideComponent(WorldpayCheckoutB2BCheckoutDeliveryAddressComponent, {
      add: {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(WorldpayCheckoutB2BCheckoutDeliveryAddressComponent);
  ...
  describe('UI new address form', () => {
    const getAddNewAddressBtn = () =>
      fixture.debugElement
        .queryAll(By.css('.btn-secondary'))
        .find(
          (el) => el.nativeElement.innerText.toLowerCase() === 'checkoutAddress.addNewAddress'.toLowerCase()
        );
    const getNewAddressForm = () =>
      fixture.debugElement.query(By.directive(MockWorldpayAddressFormComponent));
