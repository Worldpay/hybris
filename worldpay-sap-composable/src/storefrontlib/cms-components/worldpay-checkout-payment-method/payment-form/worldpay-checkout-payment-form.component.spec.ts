...
import { WorldpayBillingAddressFormService, WorldpayCheckoutPaymentFacade, WorldpayConnector, WorldpayFraudsightFacade, WorldpayUserPaymentService } from '../../../../core';
...
class MockUserPaymentService implements Partial<WorldpayUserPaymentService> {
...
describe('WorldpayCheckoutPaymentFormComponent', () => {
  let component: WorldpayCheckoutPaymentFormComponent;
  let fixture: ComponentFixture<WorldpayCheckoutPaymentFormComponent>;
  ...
  beforeEach(waitForAsync(() => {
    ...
    }).overrideComponent(WorldpayCheckoutPaymentFormComponent, {
      remove: {
        imports: [
          TranslatePipe,
          CxDatePipe,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(WorldpayCheckoutPaymentFormComponent);
  ...
  it('should hide save payment option if canSaveCard returns false', () => {
    spyOn(mockCheckoutPaymentService, 'canSaveCard').and.returnValue(of(false));
    component.ngOnInit();
    fixture.detectChanges();
    const saveCardInput = fixture.debugElement.query(By.css('#saveCard'));
    expect(saveCardInput).toBeFalsy();
  });

  it('should show save payment option if canSaveCard returns true', () => {
    spyOn(mockCheckoutPaymentService, 'canSaveCard').and.returnValue(of(true));
    component.ngOnInit();
    fixture.detectChanges();
    const saveCardInput = fixture.debugElement.query(By.css('#saveCard'));
    expect(saveCardInput).toBeTruthy();
  });
  ...
  describe('UI continue button', () => {
    ...
    it('should check setAsDefaultField to determine whether setAsDefault checkbox displayed or not', () => {
      fixture.componentRef.setInput('setAsDefaultField', false);
      fixture.detectChanges();
      ...
      fixture.componentRef.setInput('setAsDefaultField', true); // fuerza input
      fixture.detectChanges();
