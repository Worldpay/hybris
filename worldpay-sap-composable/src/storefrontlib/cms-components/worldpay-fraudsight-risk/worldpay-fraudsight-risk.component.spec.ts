...
class MockWorldpayFraudsightService implements Partial<WorldpayFraudsightFacade> {
...
describe('WorldpayFraudsightRiskComponent', () => {
  ...
  let service: WorldpayFraudsightFacade;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(WorldpayFraudsightFacade);
