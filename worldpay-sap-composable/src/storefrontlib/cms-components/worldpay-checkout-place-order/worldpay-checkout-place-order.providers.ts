...
/**
 * Providers for the Worldpay Checkout Place Order feature.
 *
 ...
 *
 * ### Usage:
 * 1. Register these providers in your `app.config.ts` (or equivalent) using `provideWorldpayCheckoutPlaceOrder()`.
...
/**
 * Factory function to provide all Worldpay Checkout Place Order feature providers as environment providers.
 *
 * @returns EnvironmentProviders for the Worldpay Checkout Place Order feature
 * @since 221121.11.0
 */
export function provideWorldpayCheckoutPlaceOrder(): EnvironmentProviders {
