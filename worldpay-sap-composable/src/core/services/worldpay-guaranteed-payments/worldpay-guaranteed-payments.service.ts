...
import { SetGuaranteedPaymentsEnabledEvent, SetGuaranteedPaymentsSessionIdEvent } from '../../events';
import { WorldpayGuaranteedPaymentsFacade } from '../../facade';
...
export class WorldpayGuaranteedPaymentsService implements WorldpayGuaranteedPaymentsFacade {
  ...
  protected loadScriptService: LoadScriptService = inject(LoadScriptService);
  ...
  protected worldpayGuaranteedPaymentsConnector: WorldpayGuaranteedPaymentsConnector = inject(WorldpayGuaranteedPaymentsConnector);
