...
import { WorldpayOrderConfirmationOverviewComponent } from './worldpay-order-confirmation-overview.component';
...
describe('OrderConfirmationOverviewComponent', () => {
  let component: WorldpayOrderConfirmationOverviewComponent;
  let fixture: ComponentFixture<WorldpayOrderConfirmationOverviewComponent>;
  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [WorldpayOrderConfirmationOverviewComponent],
        providers: [{
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(WorldpayOrderConfirmationOverviewComponent);
