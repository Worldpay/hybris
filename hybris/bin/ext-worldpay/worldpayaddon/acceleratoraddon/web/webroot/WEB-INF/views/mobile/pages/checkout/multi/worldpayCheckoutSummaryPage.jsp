...
<%@ taglib prefix="wp-checkout" tagdir="/WEB-INF/tags/addons/worldpayaddon/mobile/checkout/multi"%>
...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<jsp:body>
		...
		<div data-theme="d" data-role="content">
			<div data-theme="b">
				<wp-checkout:summaryFlow deliveryMode="${deliveryMode}" paymentInfo="${paymentInfo}" requestSecurityCode="${requestSecurityCode}"
						cartData="${cartData}" />
			</div>
		</div>
		<div data-theme="d">
