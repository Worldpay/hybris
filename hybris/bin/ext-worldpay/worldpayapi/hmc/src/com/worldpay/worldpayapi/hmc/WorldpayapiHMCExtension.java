...
public class WorldpayapiHMCExtension extends HMCExtension {

    /** Edit the local|project.properties to change logging behavior (properties log4j.*). */
    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(WorldpayapiHMCExtension.class.getName());

    /** Path to the resource bundles. */
    public final static String RESOURCE_PATH = "worldpayapi.hmc.locales";


    /**
     * @see HMCExtension#getTreeNodeChips(DisplayState,
     *      Chip)
     */
    @Override
    ...
    /**
     * @see HMCExtension#getMenuEntrySlotEntries(DisplayState,
     *      Chip)
     */
    @Override
    ...
    /**
     * @see HMCExtension#getSectionChips(DisplayState,
     *      ClipChip)
     */
    @Override
    ...
    /**
     * @see HMCExtension#getToolbarActionChips(DisplayState,
     *      Chip)
     */
    @Override
