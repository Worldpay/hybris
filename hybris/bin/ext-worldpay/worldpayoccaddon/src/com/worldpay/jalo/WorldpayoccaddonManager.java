...
import com.worldpay.constants.WorldpayoccaddonConstants;



/**
 * This is the extension manager of the worldpayoccaddon extension.
 */
public class WorldpayoccaddonManager extends GeneratedWorldpayoccaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WorldpayoccaddonManager.class.getName());
	 ...
	 */
	public WorldpayoccaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WorldpayoccaddonManager called.");
		}
	}
	 ...
	 */
	public static WorldpayoccaddonManager getInstance()
	{
		return (WorldpayoccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(WorldpayoccaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WorldpayoccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WorldpayoccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
