 ...
 *  
 */
package com.worldpay.worldpaynotificationaddon.hmc;
...
/**
 * Provides necessary meta information about the AcceleratorCms hmc extension.
 *
 * @version ExtGen v4.1
 */
public class WorldpaynotificationaddonHMCExtension extends HMCExtension {
    /**
     * Edit the local|project.properties to change logging behavior (properties log4j.*).
     */
    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(WorldpaynotificationaddonHMCExtension.class.getName());

    /**
     * Path to the resource bundles.
     */
    public static final String RESOURCE_PATH = "com.worldpay.worldpaynotificationaddon.hmc.locales";
