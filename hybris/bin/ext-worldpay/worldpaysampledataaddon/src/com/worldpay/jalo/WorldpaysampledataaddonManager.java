...
/**
 * This is the extension manager of the Worldpaysampledataaddon extension.
 */
public class WorldpaysampledataaddonManager extends GeneratedWorldpaysampledataaddonManager
{
	 ...
	 */
	public static WorldpaysampledataaddonManager getInstance()
	{
		return (WorldpaysampledataaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WorldpaysampledataaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WorldpaysampledataaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WorldpaysampledataaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WorldpaysampledataaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WorldpaysampledataaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
