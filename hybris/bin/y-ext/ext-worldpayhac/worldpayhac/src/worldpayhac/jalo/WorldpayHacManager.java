...
public class WorldpayHacManager extends GeneratedWorldpayHacManager
{
	...
	{
		return (WorldpayHacManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WorldpayHacConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WorldpayHacManager() // NOPMD
	{
