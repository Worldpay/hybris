...
/**
 * This is the extension manager of the Worldpayfulfilment extension.
 */
public class WorldpayfulfilmentManager extends GeneratedWorldpayfulfilmentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WorldpayfulfilmentManager.class.getName());
	 ...
	 */
	public static WorldpayfulfilmentManager getInstance()
	{
		return (WorldpayfulfilmentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WorldpayfulfilmentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WorldpayfulfilmentManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WorldpayfulfilmentManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WorldpayfulfilmentManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WorldpayfulfilmentManager called, current tenant: " + getTenant().getTenantID());
		}
	}
