...
/**
 * This is the extension manager of the Worldpayb2cdemo extension.
 */
public class Worldpayb2cdemoManager extends GeneratedWorldpayb2cdemoManager {
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Worldpayb2cdemoManager.class.getName());
	 ...
	 */
	public static Worldpayb2cdemoManager getInstance() {
		return (Worldpayb2cdemoManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Worldpayb2cdemoConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Worldpayb2cdemoManager() { // NOPMD
		if (LOG.isDebugEnabled()) {
			LOG.debug("constructor of Worldpayb2cdemoManager called.");
		}
	}
	...
	public void init() {
		if (LOG.isDebugEnabled()) {
			LOG.debug("init() of Worldpayb2cdemoManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy() {
		if (LOG.isDebugEnabled()) {
			LOG.debug("destroy() of Worldpayb2cdemoManager called, current tenant: " + getTenant().getTenantID());
		}
	}
