 ...
 *  
 */
package com.worldpay.worldpaytests.jalo;
...
/**
 * This is the extension manager of the Worldpaytests extension.
 */
public class WorldpaytestsManager extends GeneratedWorldpaytestsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WorldpaytestsManager.class.getName());
	 ...
	 */
	public static WorldpaytestsManager getInstance()
	{
		return (WorldpaytestsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WorldpaytestsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WorldpaytestsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WorldpaytestsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WorldpaytestsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WorldpaytestsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
