...
public class DefaultWorldpayCaptureResponseBuilderTest {
    ...
    public void shouldBuildResponseContainingOrderCode() {
        ...
        final CaptureReceived captureReceived = (CaptureReceived) ok.().get(0);
