...
public class DefaultWorldpayMockFacadeTest {
    ...
    public void shouldBuildDirectResponseIfPaymentServiceContainsSubmitWithPaymentDetails() throws WorldpayException {
        ...
        when(orderMock.())
    ...
    public void shouldReturnCaptureResponseIfRequestContainsModifyWithCapture() throws WorldpayException {
        ...
        when(modifyMock.getOrderModificationOrBatchModificationOrAccountBatchModificationOrFuturePayAgreementModificationOrPaymentTokenUpdateOrPaymentTokenDeleteOrDeleteNetworkPaymentToken()).thenReturn(singletonList(orderModificationMock));
        when(orderModificationMock.getCancelOrCaptureOrProvideCryptogramOrRefundOrRevokeOrAddBackOfficeCodeOrAuthoriseOrIncreaseAuthorisationOrCancelOrRefundOrDefendOrShopperWebformRefundDetailsOrExtendExpiryDateOrCancelRefundOrCancelRetryOrVoidSaleOrApprove()).thenReturn(singletonList(captureMock));
    ...
    public void shouldReturnNullIfRequestContainsModifyWithoutCapture() throws WorldpayException {
        when(paymentServiceMock.getSubmitOrModifyOrInquiryOrReplyOrNotifyOrVerify()).thenReturn(singletonList(modifyMock));
        when(modifyMock.getOrderModificationOrBatchModificationOrAccountBatchModificationOrFuturePayAgreementModificationOrPaymentTokenUpdateOrPaymentTokenDeleteOrDeleteNetworkPaymentToken()).thenReturn(singletonList(batchModification));
    ...
    public void shouldReturnTokenWhenRequestContainsPaymentTokenCreate() throws WorldpayException {
        when(paymentServiceMock.getSubmitOrModifyOrInquiryOrReplyOrNotifyOrVerify()).thenReturn(singletonList(submitMock));
        when(submitMock.getOrderOrOrderBatchOrShopperOrFuturePayAgreementOrMakeFuturePayPaymentOrIdentifyMeRequestOrPaymentTokenCreateOrChallengeOrCreateAccessToken()).thenReturn(singletonList(paymentTokenCreateMock));
