...
public class DefaultWorldpayMockFacadeTest {
    ...
    public void shouldBuildDirectResponseIfPaymentServiceContainsSubmitWithPaymentDetails() throws WorldpayException {
        ...
        when(orderMock.())
    ...
    public void shouldReturnCaptureResponseIfRequestContainsModifyWithCapture() throws WorldpayException {
        ...
        when(orderModificationMock.getCancelOrCaptureOrRefundOrRevokeOrAddBackOfficeCodeOrAuthoriseOrIncreaseAuthorisationOrCancelOrRefundOrDefendOrShopperWebformRefundDetailsOrExtendExpiryDateOrCancelRefundOrCancelRetryOrVoidSaleOrApprove()).thenReturn(singletonList(captureMock));
