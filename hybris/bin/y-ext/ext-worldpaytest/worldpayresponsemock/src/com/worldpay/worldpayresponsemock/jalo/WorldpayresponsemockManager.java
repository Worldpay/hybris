 ...
 *  
 */
package com.worldpay.worldpayresponsemock.jalo;
...
/**
 * This is the extension manager of the Worldpayresponsemock extension.
 */
public class WorldpayresponsemockManager extends GeneratedWorldpayresponsemockManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WorldpayresponsemockManager.class.getName());
	 ...
	 */
	public static WorldpayresponsemockManager getInstance()
	{
		return (WorldpayresponsemockManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WorldpayresponsemockConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WorldpayresponsemockManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WorldpayresponsemockManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WorldpayresponsemockManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WorldpayresponsemockManager called, current tenant: " + getTenant().getTenantID());
		}
	}
