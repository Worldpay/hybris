package com.worldpay.worldpayextocctests.test.groovy.webservicetests.v2.spock.orders
...
class PlaceOrderTest extends AbstractWorldpaySpockTest {
    ...
    def "Place order with 3D secure needed : #format"() {
        ...
        where:
        format << [org.apache.http.entity.ContentType.APPLICATION_XML, org.apache.http.entity.ContentType.APPLICATION_JSON]
    }
