...
abstract class AbstractSpockTest extends Specification {
    ...
    private static String LOG4J_PROPERTIES_CLASS_PATH = "worldpayextocctest/log4j.properties"
    ...
    protected
    static ConfigObject config = TestConfigFactory.createConfig("v2", "/worldpayextocctests/groovytests-property-file.groovy")
    ...
    protected getOAuth2TokenUsingClientCredentials(RESTClient client, clientId, clientSecret) {
        ...
        with(response) {
            ...
            assert status == org.apache.http.HttpStatus.SC_OK
