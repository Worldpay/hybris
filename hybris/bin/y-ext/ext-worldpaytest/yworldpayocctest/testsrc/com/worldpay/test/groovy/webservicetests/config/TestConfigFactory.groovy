...
class TestConfigFactory {
	...
	static synchronized ConfigObject createConfig(String version, String propertyFileClassPath) {
	...
	static ConfigObject createConfigInternal(String version, String propertyFileClassPath) {
