...
import com.worldpay.constants.WorldpayomsConstants;



/**
 * This is the extension manager of the Worldpayoms extension.
 */
public class WorldpayomsManager extends GeneratedWorldpayomsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WorldpayomsManager.class.getName());
	 ...
	 */
	public static WorldpayomsManager getInstance()
	{
		return (WorldpayomsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WorldpayomsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WorldpayomsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WorldpayomsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WorldpayomsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WorldpayomsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
