...
import com.worldpay.constants.Worldpayb2baddonConstants;



/**
 * This is the extension manager of the Worldpayb2baddon extension.
 */
public class Worldpayb2baddonManager extends GeneratedWorldpayb2baddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Worldpayb2baddonManager.class.getName());
	 ...
	 */
	public static Worldpayb2baddonManager getInstance()
	{
		return (Worldpayb2baddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Worldpayb2baddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Worldpayb2baddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Worldpayb2baddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Worldpayb2baddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Worldpayb2baddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
