...
public class WorldpayB2BThreeDSecureEndpointControllerTest {
    ...
    @Spy
    @InjectMocks
    private WorldpayB2BThreeDSecureEndpointController testObj = new WorldpayB2BThreeDSecureEndpointController();
    ...
    public void shouldRedirectToOrderConfirmationPageOnAuthorisedDirectResponse() throws InvalidCartException, WorldpayException {
        ...
        when(checkoutFacade.placeOrder(any())).thenReturn(orderDataMock);
