...
public class WorldpayB2BCseCheckoutStepController extends AbstractWorldpayDirectCheckoutStepController {

    private static final Logger LOGGER = LoggerFactory.getLogger(WorldpayB2BCseCheckoutStepController.class);
