...
public class WorldpayB2BCartsController extends AbstractWorldpayController {
    ...
    protected ConfigurablePopulator<HttpServletRequest, PaymentDetailsWsDTO, PaymentDetailsWsDTOOption> httpRequestPaymentDetailsWsDTOPopulator;
    @Resource(name = "occWorldpayHostedOrderFacade")
    protected WorldpayHostedOrderFacade worldpayHostedOrderFacade;
    @Resource
    protected APMAvailabilityFacade apmAvailabilityFacade;
    @Resource
    ...
    @Resource(name = "occB2BWorldpayDirectOrderFacade")
    ...
    public PaymentDetailsWsDTO addPaymentDetails(final HttpServletRequest request,
        ...
        return callSuperAddPaymentDetailsInternal(request, paymentDetails, fields);
    }
    ...
    public PlaceOrderResponseWsDTO addPaymentDetailsAndPlaceOrder(final HttpServletRequest request,
                                                                  ...
                                                                  @RequestBody final PaymentDetailsWsDTO paymentDetails,
                                                                  @PathVariable final String cartId) throws WorldpayException, InvalidCartException {
    ...
    protected WorldpayAdditionalInfoData callSuperCreateWorldpayAdditionalInfo(final HttpServletRequest request,
                                                                               final PaymentDetailsWsDTO paymentDetails,
                                                                               final String cartId,
                                                                               final CSEAdditionalAuthInfo cseAdditionalAuthInfo) {
        return createWorldpayAdditionalInfo(request, cseAdditionalAuthInfo, cartId, paymentDetails.getBrowserInfo());
    }
    ...
    public PaymentDataWsDTO getRedirectAuthorise(@RequestBody final PaymentRequestData paymentRequest,
        ...
        final WorldpayAdditionalInfoData worldpayAdditionalInfoData = callSuperCreateWorldpayAdditionalInfo(request);
        ...
        if (worldpayBankConfigurationFacade.isBankTransferApm(paymentMethod)) {
            ...
            paymentData.setPostUrl(worldpayB2BDirectOrderFacade.authoriseBankTransferRedirect(additionalAuthInfo, worldpayAdditionalInfoData));
    ...
    protected WorldpayAdditionalInfoData callSuperCreateWorldpayAdditionalInfo(final HttpServletRequest request) {
        return createWorldpayAdditionalInfo(request);
    }
    ...
    protected void validateCart() throws InvalidCartException {
        try {
