	...
	<c:if test="${expressCheckoutAllowed}">
		<div class="expressCheckoutCheckbox">
			<label for="expressCheckoutCheckbox">
				<input id="expressCheckoutCheckbox" type="checkbox" data-express-checkout-url="<c:url value='/checkout/multi/worldpay/summary/express'/>" class="form doExpressCheckout"/>
