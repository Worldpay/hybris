 ...
 *  
 */
package com.worldpay.worldpaynotificationaddon.jalo;
...
import com.worldpay.worldpaynotificationaddon.constants.WorldpaynotificationaddonConstants;



/**
 * This is the extension manager of the Worldpaynotificationaddon extension.
 */
public class WorldpaynotificationaddonManager extends GeneratedWorldpaynotificationaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WorldpaynotificationaddonManager.class.getName());
	 ...
	 */
	public static WorldpaynotificationaddonManager getInstance()
	{
		return (WorldpaynotificationaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WorldpaynotificationaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WorldpaynotificationaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WorldpaynotificationaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WorldpaynotificationaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WorldpaynotificationaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
