...
public class CaptureServiceRequestIntegrationTest extends ServicelayerBaseTest {
    ...
    public void testCapturePartialAmount() throws WorldpayException {
        ...
        final CaptureServiceRequest request = CaptureServiceRequest.createCaptureRequest(merchantInfo, orderCode, new Amount("70", "EUR", "2"), null);
        final CaptureServiceResponse capture = gateway.capture(request);
    ...
    public void testCaptureMoreThanAuthorised() throws WorldpayException {
        ...
        final CaptureServiceRequest request = CaptureServiceRequest.createCaptureRequest(merchantInfo, orderCode, new Amount("140", "EUR", "2"), null);
        final CaptureServiceResponse capture = gateway.capture(request);
