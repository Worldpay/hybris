...
public class KlarnaSliceItPaymentPopulatorTest {
    ...
    @InjectMocks
    private KlarnaSliceItPaymentPopulator testObj;
    ...
    public void populate_WhenSourceIsNull_ShouldThrowAnException() {
        testObj.populate(null, new KLARNASLICEITSSL());
    }
    ...
    public void populate_ShouldPopulateKlarnaPayment() {
        ...
        final KLARNASLICEITSSL targetMock = new KLARNASLICEITSSL();
