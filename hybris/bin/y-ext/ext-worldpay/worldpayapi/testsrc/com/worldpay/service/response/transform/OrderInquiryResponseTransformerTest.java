...
public class OrderInquiryResponseTransformerTest {
    ...
    public void transform_ShouldFullyPopulateOrderInquiry_WhenAllDataIsPresentWithNoErrors() throws WorldpayModelTransformationException {
        ...
        when(orderStatusMock.())
