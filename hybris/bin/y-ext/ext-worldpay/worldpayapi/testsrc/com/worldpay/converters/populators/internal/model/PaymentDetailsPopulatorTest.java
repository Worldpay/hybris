...
public class PaymentDetailsPopulatorTest {
    ...
    public void populate_WhenGetPaymentIsNull_ShouldNotPopulatePayment() {
        ...
        assertThat(target.()).isEmpty();
    }
    ...
    public void populate_WhenSourceAndTargetAreNotNullAndAllTheFieldsAreNotNull_ShouldPopulate() {
        ...
        assertThat(((PaResponse) target.getInfo3DSecure().getPaResponseOrMpiProviderOrMpiResponseOrAttemptedAuthenticationOrCompletedAuthenticationOrThreeDSVersionOrMerchantNameOrXidOrDsTransactionIdOrCavvOrEci().get(0)).getvalue())
