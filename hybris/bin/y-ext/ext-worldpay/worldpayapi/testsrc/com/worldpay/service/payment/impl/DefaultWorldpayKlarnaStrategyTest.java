...
public class DefaultWorldpayKlarnaStrategyTest {
    ...
    public void shouldPopulateOrderLinesFixedDiscountWithoutDelivery() throws WorldpayConfigurationException {
        ...
        assertThat(lineItemDiscount.getLineItemType()).isEqualTo(LineItem.LINE_ITEM_TYPE.DISCOUNT);
    ...
    public void shouldPopulateOrderLinesFixedAndPercentageDiscountDelivery() throws WorldpayConfigurationException {
        ...
        assertThat(lineItem2.getLineItemType()).isEqualTo(LineItem.LINE_ITEM_TYPE.PHYSICAL);
        ...
        assertThat(lineItemShipping.getLineItemType()).isEqualTo(LineItem.LINE_ITEM_TYPE.SHIPPING_FEE);
