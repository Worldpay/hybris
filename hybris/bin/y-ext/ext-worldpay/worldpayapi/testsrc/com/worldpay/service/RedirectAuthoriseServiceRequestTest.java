...
public class RedirectAuthoriseServiceRequestTest {
    ...
    private static final List<PaymentMethodAttribute> PAYMENT_METHOD_ATTRIBUTE = singletonList(new PaymentMethodAttribute());
    ...
    public void setUp() throws Exception {
        ...
        orderLines = new OrderLines(TAX_AMOUNT, TERMS_URL, Arrays.asList(lineItemOne, lineItemTwo));
