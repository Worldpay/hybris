...
public class RedirectAuthoriseResponseTransformerTest {
    ...
    public void transformShouldReturnARedirectAuthoriseServiceResponse() throws Exception {
        ...
        final List<Object> statusElements = paymentReply.();
