...
import com.worldpay.internal.model.FulfillmentMethodType;
...
class DefaultWorldpayXMLValidatorTest {
    ...
    @Test
    void testValidate() throws WorldpayValidationException, WorldpayModelTransformationException {
    ...
    @Test
    void testValidate_whit_GP() throws WorldpayValidationException, WorldpayModelTransformationException {
        final List<PaymentType> includedPTs = singletonList(ONLINE);
        final Shopper shopper = new Shopper();
        shopper.setShopperEmailAddress(EMAIL_ADDRESS);
        shopper.setAuthenticatedShopperID(AUTH_SHOPPER_ID);
    ...
    @Test
    void testValidateXMLWithCreateTokenWithShopperScope() throws WorldpayValidationException, WorldpayModelTransformationException {
        final List<PaymentType> includedPTs = singletonList(ONLINE);
        final Shopper shopper = new Shopper();
        shopper.setShopperEmailAddress(EMAIL_ADDRESS);
        shopper.setAuthenticatedShopperID(AUTH_SHOPPER_ID);
    ...
    @Test
    void testValidateXMLWithCreateTokenWithMerchantScope() throws WorldpayValidationException, WorldpayModelTransformationException {
        final List<PaymentType> includedPTs = singletonList(ONLINE);
        final Shopper shopper = new Shopper();
        shopper.setShopperEmailAddress(EMAIL_ADDRESS);
        shopper.setAuthenticatedShopperID(AUTH_SHOPPER_ID);
    ...
    private AuthoriseRequestParameters getAuthoriseRequestParameters(final List<PaymentType> includedPTs, final Shopper shopper, final TokenRequest tokenRequest) {
    ...
    private com.worldpay.internal.model.Order createOrderWithMandatoryFields() {
        ...
        intOrder.().add(new Description());
        intOrder.().add(createAmount());
        intOrder.().add(createRisk());
    ...
    private com.worldpay.internal.model.GuaranteedPaymentsData createGuaranteedPayments() {
        final com.worldpay.internal.model.GuaranteedPaymentsData internalGPData = new com.worldpay.internal.model.GuaranteedPaymentsData();
        ...
        internalGPData.setTotalShippingCost(VALUE);
        internalGPData.setFulfillmentMethodType(fulfillmentMethodType);
        internalGPData.setSecondaryAmount(secondaryAmount);
        internalGPData.setSurchargeAmount(surchargeAmount);
        internalGPData.setDiscountCodes(discountCodes);
        internalGPData.setUserAccount(userAccount);
        internalGPData.setProductDetails(productDetails);

        return internalGPData;
    }
