...
public class KlarnaV2PaymentPopulatorTest {
    ...
    @InjectMocks
    private KlarnaV2PaymentPopulator testObj;
    ...
    public void populate_WhenSourceIsNull_ShouldThrowAnException() {
        testObj.populate(null, new KLARNAV2SSL());
    }
    ...
    public void populate_ShouldPopulateKlarnaPayment() {
        ...
        final KLARNAV2SSL targetMock = new KLARNAV2SSL();
