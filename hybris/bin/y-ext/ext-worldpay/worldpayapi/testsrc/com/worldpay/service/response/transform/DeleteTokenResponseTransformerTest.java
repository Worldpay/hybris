...
public class DeleteTokenResponseTransformerTest {
    ...
    @Test
    public void shouldRaiseWorldpayModelTransformationExceptionWhenThereIsNoReplyInThePaymentService() {
    ...
    @Test
    public void shouldRaiseWorldpayModelTransformationExceptionWhenResponseIsNotAReply() {
    ...
    public void shouldThrowExceptionWhenResponseIsNotOk() {
        ...
        assertThatThrownBy(() -> testObj.transform(paymentServiceMock))
                .isInstanceOf(WorldpayModelTransformationException.class)
                .hasMessage("DeleteTokenResponse did not contain an OK object");
    }
