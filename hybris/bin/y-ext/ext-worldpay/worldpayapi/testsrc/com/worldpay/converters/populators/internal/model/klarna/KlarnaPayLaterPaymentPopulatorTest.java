...
public class KlarnaPayLaterPaymentPopulatorTest {
    ...
    @InjectMocks
    private KlarnaPayLaterPaymentPopulator testObj;
    ...
    public void populate_WhenSourceIsNull_ShouldThrowAnException() {
        testObj.populate(null, new KLARNAPAYLATERSSL());
    }
    ...
    public void populate_ShouldPopulateKlarnaPayment() {
        ...
        final KLARNAPAYLATERSSL targetMock = new KLARNAPAYLATERSSL();
