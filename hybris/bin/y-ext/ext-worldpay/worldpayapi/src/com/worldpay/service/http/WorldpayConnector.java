...
public interface WorldpayConnector {
     ...
     * @param paymentMethod  String payment method being used in the request
     ...
     */
    ServiceReply send(final PaymentService paymentService, final MerchantInfo merchantInfo, final String cookie, final String paymentMethod) throws WorldpayException;
