...
/**
 * Helper class with commonly used methods by the {@link ServiceResponseTransformer} objects
 */
@SuppressWarnings("PMD.ClassWithOnlyPrivateConstructorsShouldBeFinal")
public class ServiceResponseTransformerHelper {

    private static final ServiceResponseTransformerHelper INSTANCE = new ServiceResponseTransformerHelper();

    // Private constructor to ensure there's only one instance
    private ServiceResponseTransformerHelper() {
    }

    /**
     * @return the helper instance
     */
    public static ServiceResponseTransformerHelper getInstance() {
        return INSTANCE;
    }
    ...
    public boolean checkForError(ServiceResponse response, Reply reply) {
        ...
        if (replyType instanceof com.worldpay.internal.model.Error) {
            com.worldpay.internal.model.Error intError = (com.worldpay.internal.model.Error) replyType;
            ErrorDetail errorDtl = buildErrorDetail(intError);
            ...
            if (statusType instanceof com.worldpay.internal.model.Error) {
                com.worldpay.internal.model.Error intError = (com.worldpay.internal.model.Error) statusType;
                ErrorDetail errorDtl = buildErrorDetail(intError);
                response.setError(errorDtl);
                return true;
            }
