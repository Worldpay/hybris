...
/**
 * This is the extension manager of the Worldpayapi extension.
 */
public class WorldpayapiManager extends GeneratedWorldpayapiManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WorldpayapiManager.class.getName());
	 ...
	 */
	public static WorldpayapiManager getInstance()
	{
		return (WorldpayapiManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WorldpayapiConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WorldpayapiManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WorldpayapiManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WorldpayapiManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WorldpayapiManager called, current tenant: " + getTenant().getTenantID());
		}
	}
