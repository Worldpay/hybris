...
public class DefaultWorldpayRequestFactory implements WorldpayRequestFactory {
    ...
    private static final String FIRST_IN_BILLING_RUN = "firstInBillingRun";
    private static final Set<String> tokenizedAPMs = Set.of(PaymentType.PAYPAL_EXPRESS.getMethodCode(), PaymentType.SEPA.getMethodCode());
    ...
    public DefaultWorldpayRequestFactory(
            final WorldpayTokenEventReferenceCreationStrategy worldpayTokenEventReferenceCreationStrategy,
     ...
     */
    @Override
    public CreateTokenServiceRequest buildTokenRequest(
     ...
     */
    @Override
    public UpdateTokenServiceRequest buildTokenUpdateRequest(
            final MerchantInfo merchantInfo,
            final CSEAdditionalAuthInfo cseAdditionalAuthInfo,
            final WorldpayAdditionalInfoData worldpayAdditionalInfoData,
        ...
        return worldpayRequestService.createUpdateTokenServiceRequest(merchantInfo, worldpayAdditionalInfoData, tokenRequest, paymentTokenID, cardDetails);
    }
     ...
     */
    @Override
    public DeleteTokenServiceRequest buildTokenDeleteRequest(
            final MerchantInfo merchantInfo,
        ...
        final TokenRequest tokenRequest = worldpayRequestService.createTokenRequestForDeletion(
                paymentInfoModel.getEventReference(),
                tokenReason,
                paymentInfoModel.getAuthenticatedShopperID()
        );

        return createDeleteTokenServiceRequest(
                merchantInfo,
                paymentInfoModel.getAuthenticatedShopperID(),
                subscriptionId,
                tokenRequest
     ...
     */
    @Override
    public DirectAuthoriseServiceRequest buildDirectAuthoriseRequestWithTokenForCSE(
            final MerchantInfo merchantInfo,
            final CartModel cartModel,
            final WorldpayAdditionalInfoData worldpayAdditionalInfoData
    ) {
        ...
        return createTokenisedDirectAuthoriseRequest(authoriseRequestParametersCreator.build());
    }
     ...
     */
    @Override
    public DirectAuthoriseServiceRequest buildDirectAuthoriseGooglePayRequest(
            final MerchantInfo merchantInfo,
            final CartModel cartModel,
            final GooglePayAdditionalAuthInfo googlePayAdditionalAuthInfo
    ) {
        final String orderCode = worldpayOrderService.generateWorldpayOrderCode(cartModel);
        final Amount amount = worldpayOrderService.createAmount(cartModel.getCurrency(), cartModel.getTotalPrice());
        final BasicOrderInfo orderInfo = worldpayOrderService.createBasicOrderInfo(orderCode, orderCode, amount);
        ...
        if (Boolean.TRUE.equals(googlePayAdditionalAuthInfo.getSaveCard())) {
     ...
     */
    @Override
    public DirectAuthoriseServiceRequest build3dDirectAuthoriseRequest(
            final MerchantInfo merchantInfo,
     ...
     */
    @Override
    public DirectAuthoriseServiceRequest buildDirectAuthoriseBankTransferRequest(
            final MerchantInfo merchantInfo,
            final CartModel cartModel,
    ...
    @Override
    public DirectAuthoriseServiceRequest buildDirectAuthoriseACHDirectDebitRequest(
            final MerchantInfo merchantInfo,
            final CartModel cartModel,
     ...
     */
    @Override
    public DirectAuthoriseServiceRequest buildDirectAuthoriseRecurringPayment(
            final MerchantInfo merchantInfo,
     ...
     */
    @Override
    public DirectAuthoriseServiceRequest buildDirectAuthoriseKlarnaRequest(
            final MerchantInfo merchantInfo,
            final CartModel cartModel,
            final WorldpayAdditionalInfoData worldpayAdditionalInfoData,
    ...
    @Override
    public DirectAuthoriseServiceRequest buildApplePayDirectAuthorisationRequest(
            final MerchantInfo merchantInfo,
            final CartModel cartModel,
    ...
    @Override
    public DirectAuthoriseServiceRequest buildDirectTokenAndAuthorise(
            final MerchantInfo merchantInfo,
            final CartModel cartModel,
            final WorldpayAdditionalInfoData worldpayAdditionalInfoData,
            final CSEAdditionalAuthInfo cseAdditionalAuthInfo
        ...
        final AuthoriseRequestParametersCreator authoriseRequestParametersCreator = AuthoriseRequestParameters.AuthoriseRequestParametersBuilder.getInstance()
                ...
                .withTokenRequest(tokenRequest)
                .withStoredCredentials(Boolean.TRUE.equals(cseAdditionalAuthInfo.getSaveCard()) ? storedCredentials : null)
                .withRiskData(riskData)
                .withAdditional3DSData(additional3DSData);
     ...
     */
    @Override
    public SecondThreeDSecurePaymentRequest buildSecondThreeDSecurePaymentRequest(
            final MerchantInfo merchantInfo,
            final String worldpayOrderCode,
    ...
    protected void addPayPalPaymentMethodAttribute(
            final AdditionalAuthInfo additionalAuthInfo,
        ...
        if (PaymentType.PAYPAL_EXPRESS.getMethodCode().equals(additionalAuthInfo.getPaymentMethod())) {
            ...
            paypalPaymentMethodAttribute.setAttrName(FIRST_IN_BILLING_RUN);
            paypalPaymentMethodAttribute.setAttrValue(Boolean.TRUE.toString());
            authoriseRequestParametersCreator.withPaymentMethodAttributes(List.of(paypalPaymentMethodAttribute));
        }
    }

    protected StoredCredentials createRecurringStoredCredentials(
            final AbstractOrderModel abstractOrderModel,
    ...
    protected DeleteTokenServiceRequest createDeleteTokenServiceRequest(
            final MerchantInfo merchantInfo,
            final String authenticatedShopperID,
            final String subscriptionId,
            final TokenRequest tokenRequest
    ) {
        return DeleteTokenServiceRequest.deleteTokenRequest(merchantInfo, authenticatedShopperID, subscriptionId, tokenRequest);
    }
    ...
    protected AuthoriseRequestParametersCreator internalCreateCommonRedirectAuthoriseServiceRequest(
            final MerchantInfo merchantInfo,
            final CartModel cartModel,
            final AdditionalAuthInfo additionalAuthInfo,
            final WorldpayAdditionalInfoData worldpayAdditionalInfoData
    ...
    protected RedirectAuthoriseServiceRequest internalGetRedirectAuthoriseServiceRequest(
            final CartModel cartModel,
            final AdditionalAuthInfo additionalAuthInfo,
            final AuthoriseRequestParametersCreator authoriseRequestParametersCreator,
            final WorldpayAdditionalInfoData worldpayAdditionalInfoData
        ...
        authoriseRequestParametersCreator.withInstallationId(additionalAuthInfo.getInstallationId()).withIncludedPTs(includedPTs);

        if (Boolean.TRUE.equals(additionalAuthInfo.getSaveCard())) {
            final String authenticatedShopperId = worldpayCartService.getAuthenticatedShopperId(cartModel);
            ...
            authoriseRequestParametersCreator
                    .withShopper(shopper)
                    .withTokenRequest(tokenRequest);
            storeCredentials(additionalAuthInfo, authoriseRequestParametersCreator);
            addPayPalPaymentMethodAttribute(additionalAuthInfo, authoriseRequestParametersCreator);
    ...
    protected void storeCredentials(
        ...
        if (!tokenizedAPMs.contains(additionalAuthInfo.getPaymentMethod())) {
            final StoredCredentials storedCredentials = worldpayRequestService.createStoredCredentials(Usage.FIRST, null, null);
            authoriseRequestParametersCreator.withStoredCredentials(storedCredentials);
        }
    }

    protected RedirectAuthoriseServiceRequest internalGetRedirectAuthoriseServiceRequestForKlarna(
            final CartModel cartModel,
            final AdditionalAuthInfo additionalAuthInfo,
            final AuthoriseRequestParametersCreator authoriseRequestParametersCreator
    ) throws WorldpayConfigurationException {
        final CustomerModel customerModel = (CustomerModel) cartModel.getUser();
        final Payment payment = worldpayOrderService.createKlarnaPayment(worldpayCartService.getBillingAddress(cartModel, additionalAuthInfo).getCountryCode(), customerModel.getSessionLanguage(), null, additionalAuthInfo.getPaymentMethod());
        final OrderLines orderLines = worldpayKlarnaService.createOrderLines(cartModel);
        final String shopperEmailAddress = worldpayCartService.getEmailForCustomer(cartModel);
        final String statementNarrative = additionalAuthInfo.getStatementNarrative();
        final Shopper shopper = worldpayRequestService.createShopper(shopperEmailAddress, null, null);
    ...
    protected RedirectAuthoriseServiceRequest internalGetRedirectAuthoriseServiceRequestForAlternativePayments(
        ...
        final Payment payment = worldpayOrderService.createAlternativePayment(worldpayCartService.getBillingAddress(cartModel, additionalAuthInfo).getCountryCode(), additionalAuthInfo.getPaymentMethod());
