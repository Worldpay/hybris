...
public class HMAC256MacValidator implements MacValidator {
    ...
    public boolean validateResponse(final String orderKey, final String worldpayMac, final String paymentAmount,
                                    final String paymentCurrency, final String paymentStatus, final String macSecret)
        ...
        final String hashString = StringUtils.join(asList(orderKey, paymentAmount, paymentCurrency, paymentStatus), ":");
        try {
