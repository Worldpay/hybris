...
public class SecondThreeDSecurePaymentRequestTransformer implements ServiceRequestTransformer {
    ...
    public PaymentService transform(final ServiceRequest request) throws WorldpayModelTransformationException {
        ...
        final List<Object> completedAuthenticationList = info3DSecure.getPaResponseOrMpiProviderOrMpiResponseOrAttemptedAuthenticationOrCompletedAuthenticationOrThreeDSVersionOrMerchantNameOrXidOrDsTransactionIdOrCavvOrEciOrDelegatedAuthentication();
