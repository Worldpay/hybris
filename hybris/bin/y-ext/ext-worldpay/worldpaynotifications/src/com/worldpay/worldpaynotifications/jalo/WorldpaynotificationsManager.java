...
public class WorldpaynotificationsManager extends GeneratedWorldpaynotificationsManager
{
	 ...
	 */
	public static WorldpaynotificationsManager getInstance()
	{
		return (WorldpaynotificationsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(WorldpaynotificationsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WorldpaynotificationsManager() // NOPMD 
	{
		LOG.debug("constructor of WorldpaynotificationsManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of WorldpaynotificationsManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of WorldpaynotificationsManager called, current tenant: {}", getTenant().getTenantID());
	}
