 ...
 */
package com.worldpay.worldpayasm.jalo;
...
import com.worldpay.worldpayasm.constants.WorldpayasmConstants;



/**
 * This is the extension manager of the Worldpayasm extension.
 */
public class WorldpayasmManager extends GeneratedWorldpayasmManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WorldpayasmManager.class.getName());
	 ...
	 */
	public static WorldpayasmManager getInstance()
	{
		return (WorldpayasmManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WorldpayasmConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WorldpayasmManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WorldpayasmManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WorldpayasmManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WorldpayasmManager called, current tenant: " + getTenant().getTenantID());
		}
	}
